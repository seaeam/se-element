...
<template>
  <se-collapse v-model="activeNames" accordion>
    <se-collapse-item name="1">
      <template #title>
        <span style="color: var(--se-color-danger)"> Consistency </span>
        <se-icon icon="question-circle" />
      </template>
      <div>
    ...
    <se-collapse-item title="Feedback" name="2">
      <div>
    ...
    <se-collapse-item title="Efficiency" name="3">
    ...
    <se-collapse-item title="Controllability" name="4">
      <div>
